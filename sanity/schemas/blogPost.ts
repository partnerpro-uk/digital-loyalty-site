...
export const blogPost = defineType({
  ...
  fields: [
    // === MARKDOWN IMPORT (Top of form) ===
    defineField({
      name: 'markdownImport',
      title: '📄 Import from Markdown File',
      type: 'string',
      group: 'content',
      description: 'Click the button below to import your markdown template',
      components: {
        input: MarkdownImportField
      },
      hidden: false,
      readOnly: true
    }),
    ...
    defineField({
      ...
      type: 'array',
      group: 'content',
      description: 'Write your blog post content here (or use Import button above to auto-fill)',
      of: [
        {
          type: 'block',
          styles: [
